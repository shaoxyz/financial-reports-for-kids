...
const companyNames = {
  ...
  Hormel: "Hormel Foods",
  Lululemon: "lululemon", Ciena: "Ciena", Broadcom: "Broadcom", Samsara: "Samsara", GameStop: "GameStop", Signet: "Signet Jewelers", Oracle: "Oracle", Adobe: "Adobe", Kroger: "克罗格", Chewy: "Chewy", GitLab: "GitLab", TollBrothers: "Toll Brothers", Lennar: "Lennar"
};
...
const industries = {
  ...
  Broadcom: "半导体与基础软件", Samsara: "物联网与车队软件", GameStop: "游戏与收藏品零售", Signet: "珠宝零售与服务", Oracle: "企业软件与云计算", Adobe: "创意软件与企业营销", Kroger: "食品杂货零售与零售媒体", Chewy: "宠物电商与健康服务", GitLab: "开发平台与 DevSecOps", TollBrothers: "高端住宅建造", Lennar: "住宅建造与按揭服务"
};
