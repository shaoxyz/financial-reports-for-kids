...
const companyNames = {
  ...
  Hormel: "Hormel Foods",
  Lululemon: "lululemon", Ciena: "Ciena", Broadcom: "Broadcom", Samsara: "Samsara", GameStop: "GameStop", Signet: "Signet Jewelers", Oracle: "Oracle", Adobe: "Adobe"
};
...
const industries = {
  ...
  Broadcom: "半导体与基础软件", Samsara: "物联网与车队软件", GameStop: "游戏与收藏品零售", Signet: "珠宝零售与服务", Oracle: "企业软件与云计算", Adobe: "创意软件与企业营销"
};
